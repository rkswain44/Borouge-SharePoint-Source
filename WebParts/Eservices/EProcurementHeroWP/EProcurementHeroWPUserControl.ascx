...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EProcurementHeroWPUserControl.ascx.cs" Inherits="Borouge.Internet.Main.WebParts.Eservices.EProcurementHeroWP.EProcurementHeroWPUserControl" %>

<asp:Repeater ID="rptEProcurementHero" runat="server">
    <ItemTemplate>
